...
export function AdminDashboard() {
  ...
  const [claims, setClaims] = useState<Claim[]>([
    {
      ...
      reporter: 'John Doe',
      verificationMessage: 'This is my backpack. It has my CS textbook and a red water bottle inside.',
      date: '2025-10-13',
      status: 'pending',
    },
    {
      ...
      reporter: 'Sarah Williams',
      verificationMessage: 'My wallet with initials RW embossed on the front. Has my student ID inside.',
      date: '2025-10-12',
      status: 'approved',
    },
    {
      ...
      email: 'david.lee@ccis.edu',
      reporter: 'Emily Chen',
      verificationMessage: 'White AirPods Pro with "David" engraved on the case.',
      date: '2025-10-11',
      status: 'pending',
    },
    {
      ...
      verificationMessage: 'North Face jacket, size M. My car keys should be in the left pocket.',
      date: '2025-10-10',
      status: 'rejected',
    },
  ]);
  ...
  const handleResolve = (reportId: string) => {
    ...
    customToast.success('Report Resolved', 'The report has been marked as resolved');
  };

  const openDeleteDialog = (item: Report | User) => {
