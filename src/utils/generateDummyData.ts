...
import type { LostItem } from '../services/localItemsService';

export function generateDummyItems(): LostItem[] {
...
// Export the generated data to console for saving to JSON
if (typeof window !== 'undefined') {
  (window as any).exportDummyData = () => {
